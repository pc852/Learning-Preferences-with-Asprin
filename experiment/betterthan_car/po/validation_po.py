...
val_set_1 = '../dataset_bt10fold_minimized/val1/validation_po/user'
output_1 = '../dataset_bt10fold_minimized/training_po_v1/user'
gen_types = ["bt"]
#gen_types = ["poset"]
#"aso","less_weight"],
...
for u in users:
    for g in gen_types:
        ...
        result = subprocess.run(['./../../../asprin-vL', '--min_element', '-W', 'none', file1, file2], stdout=subprocess.PIPE)
