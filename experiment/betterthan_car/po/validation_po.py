...
users = [11,15,17,19,21,23,26,3,32,38,39,4,42,43,44,45,51,52,53,55,7] #perfert users are: 4,7,11,15,17,19,38,39,42,43,51,52,55
        															  #altered are 3,21,23,26,32,44,45,53
val_ind = [1,10,2,3,4,5,6,7,8,9]
dir1 = '../dataset_bt_minimized10f'  															  
val1 = '/val'
val2 = '/validation_po/user'
val3 = '/validation_set_.lp'
out1 = '/asprin-vL-1.0-default/val'
